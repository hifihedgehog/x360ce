CREATE TABLE [dbo].[x360ce_PadSettings] (
    ...
    [LeftTriggerAntiDeadZone]  VARCHAR (16)     CONSTRAINT [DF_x360ce_PadSettings_LeftTriggerAntiDeadZone] DEFAULT ('') NOT NULL,
    [LeftTriggerLinear]        VARCHAR (16)     CONSTRAINT [DF_x360ce_PadSettings_LeftTriggerLinear] DEFAULT ('') NOT NULL,
    ...
    [RightTriggerAntiDeadZone] VARCHAR (16)     CONSTRAINT [DF_x360ce_PadSettings_RightTriggerAntiDeadZone] DEFAULT ('') NOT NULL,
    [RightTriggerLinear]       VARCHAR (16)     CONSTRAINT [DF_x360ce_PadSettings_RightTriggerLinear] DEFAULT ('') NOT NULL,
